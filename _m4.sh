#!/bin/bash
# M4: Wasserstein + Contrastive mixed (GDPO multi-FWI)
GPU=0
...
for idx in 18 50 10 6 8 5; do
  ...
  $PY train_rl_fwi.py \
    ...
    --out_dir runs/MixFWI_Wass_Contra_cva${idx} --device cuda \
