#!/bin/bash
# M5: Wasserstein + NCC_maxlag mixed
GPU=3
...
for idx in 18 50 10 6 8 5; do
  ...
  $PY train_rl_fwi.py \
    ...
    --out_dir runs/MixFWI_Wass_NCCm_cva${idx} --device cuda \
