#!/bin/bash
# Stage 1: NCC_maxlag 2500 steps (for C4 curriculum)
GPU=3
...
for idx in 18 50 10 6 8 5; do
  echo "=== $(date) NCC_maxlag CVA[$idx] GPU=$GPU ==="
  $PY train_rl_fwi.py \
    ...
    --out_dir runs/curr_nccm2500_cva${idx} --device cuda \
    --early_stop_patience 500 --early_stop_window 100 --save_every 100 --seed 42
done
echo "GPU3 ALL DONE (NCC_maxlag 2500)"
